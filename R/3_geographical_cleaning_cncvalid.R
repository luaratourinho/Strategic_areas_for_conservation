...
# loading clean occs
clean_df <- read_csv("./INEMA/Tabelas/cncflora_valided_no_hyal_11sp_Ful_stu_fauna.csv")
...
# n_records <- read_csv("./INEMA/Tabelas/cncflora_valided_no_hyal_11sp_Ful_stu_fauna/02_n_records_gspmy.csv")
# mylist2  <- read_csv("./INEMA/Tabelas/cncflora_valided_no_hyal_11sp_Ful_stu_fauna/inema_list.csv")
...
write_csv(clean_df_thin_5, path = "./INEMA/Tabelas/cncflora_valided_no_hyal_11sp_Ful_stu_fauna/03_clean_df_thin_5.csv")
write_csv(clean_df_thin_1, path = "./INEMA/Tabelas/cncflora_valided_no_hyal_11sp_Ful_stu_fauna/03_clean_df_thin_1.csv")
