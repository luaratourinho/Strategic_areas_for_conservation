...
writeOGR(nivel6, dsn = "./INEMA/Spatial_files_PAT/Mapbiomas",
         layer = "Mapbiomas_perc_nivel6_buf10km", driver="ESRI Shapefile", overwrite=T)
...
writeOGR(PAT_nivel6_Mapbiomas, dsn = "./INEMA/Spatial_files_PAT/Mapbiomas",
